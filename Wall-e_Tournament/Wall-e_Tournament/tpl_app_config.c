 ...
 * Automatically generated by goil on Fri Mar 30 14:46:06 2018
 * from root OIL file Wall-e_Tournament.oil
 *
...
/* Alarm AlarmContact identifier */
#define AlarmContact_id 0
CONST(AlarmType, AUTOMATIC) AlarmContact = AlarmContact_id;

/* Alarm AlarmDistance identifier */
#define AlarmDistance_id 1
CONST(AlarmType, AUTOMATIC) AlarmDistance = AlarmDistance_id;

/* Alarm AlarmNavigation identifier */
#define AlarmNavigation_id 2
CONST(AlarmType, AUTOMATIC) AlarmNavigation = AlarmNavigation_id;
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Detection_contact_stack_zone[500/sizeof(tpl_stack_word)];
#define APP_Task_Detection_contact_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Detection_contact_STACK {Detection_contact_stack_zone, 500}
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Detection_distance_stack_zone[500/sizeof(tpl_stack_word)];
#define APP_Task_Detection_distance_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Detection_distance_STACK {Detection_distance_stack_zone, 500}
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Navigation_stack_zone[500/sizeof(tpl_stack_word)];
#define APP_Task_Navigation_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Navigation_STACK {Navigation_stack_zone, 500}
...
CONST(tpl_task_activation_action, OS_CONST) AlarmContact_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) AlarmContact_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , AlarmContact_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&AlarmContact_action
};
...
VAR(tpl_time_obj, OS_VAR) AlarmContact_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&AlarmContact_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  100,
    /* date                         */  100,
...
/*-----------------------------------------------------------------------------
 * Alarm AlarmNavigation descriptor
 *
...
CONST(tpl_task_activation_action, OS_CONST) AlarmNavigation_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  Navigation_id
...
CONST(tpl_alarm_static, OS_CONST) AlarmNavigation_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , AlarmNavigation_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&AlarmNavigation_action
};
...
VAR(tpl_time_obj, OS_VAR) AlarmNavigation_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&AlarmNavigation_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  200,
    /* date                         */  100,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &AlarmContact_alarm_desc,
  &AlarmDistance_alarm_desc,
  &AlarmNavigation_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
...
VAR(tpl_proc_id, OS_VAR) tpl_priority_1_fifo[5];
